...
def load_dataset(batch_size=128, download=True):
    """
...
def run_LAPGAN(n_level=3, n_epoch=1, batch_size=128, use_gpu=True,
               dis_lrs=None, gen_lrs=None, noise_dim=100, n_update_dis=1, 
               n_update_gen=1, n_channel=1, n_sample=32,update_max=None):
    # loading data
    ...
    save_image(samples, './result/%s epoch%d.png'% (current_time, n_epoch))
    return samples.numpy()


if __name__ == '__main__':
    run_LAPGAN(n_epoch=1, update_max=50)
